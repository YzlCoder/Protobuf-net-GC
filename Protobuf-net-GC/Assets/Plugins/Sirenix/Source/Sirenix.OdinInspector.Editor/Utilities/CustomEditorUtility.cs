...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public static class CustomEditorUtility
    {
        ...
        public static void ExecuteWhenInitializeOnLoad()
        {
            Sirenix.OdinInspector.Editor.CustomEditorLoader.CustomEditorLoader_Constructor();

            Sirenix.Utilities.Editor.SirenixEditorGUI.LoadEditorPrefs_InitializeOnLoadMethod();

            Sirenix.OdinInspector.Editor.PersistentContextCache.PersistentContextCache_Constructor();
            Sirenix.OdinInspector.Editor.FixUnityScriptableObjectDirtying.FixUnityScriptableObjectDirtying_Constructor();
            Sirenix.OdinInspector.Editor.FixUnityAssemblyVersionResolution.FixUnityAssemblyVersionResolution_Constructor();
            Sirenix.OdinInspector.Editor.FixUnityAboutWindowBeforeEmit.FixUnityAboutWindowBeforeEmit_Constructor();
            Sirenix.OdinInspector.Editor.ColorPaletteManager.LoadEditorPrefs_InitializeOnLoadMethod();

            Sirenix.Utilities.Editor.SirenixEditorFields.LoadEditorPrefs_InitializeOnLoadMethod();
            Sirenix.Utilities.Editor.PersistentAssemblyGuidUpdater.Init_InitializeOnLoadMethod();
            Sirenix.OdinInspector.Editor.InspectorConfig.RemoveObsoleteGeneratedOdinEditorsDLL_InitializeOnLoadMethod();

            UnityEngine.Profiling.Profiler.BeginSample("UnitySerializationInitializer");
            Sirenix.Serialization.UnitySerializationInitializer.InitializeEditor_InitializeOnLoadMethod();
            UnityEngine.Profiling.Profiler.EndSample();

            Sirenix.Serialization.UnitySerializationUtility.PrefabSelectionTracker.PrefabSelectionTracker_InitializeOnLoad();
        }
