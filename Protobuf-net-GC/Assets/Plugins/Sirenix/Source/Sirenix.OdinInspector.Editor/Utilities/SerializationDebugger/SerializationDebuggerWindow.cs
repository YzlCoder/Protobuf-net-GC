...
namespace Sirenix.Utilities.Editor
{
    ...
    internal sealed class SerializationDebuggerWindow : OdinEditorWindow
    {
            ...
            Rect rect = SirenixEditorGUI.BeginHorizontalToolbar();
            {
                ...
                if (selectA || selectB)
                {
                    ...
                    p.SelectionChanged += (types) =>
                    {
                        ...
                        {
                            this.targetType = t;
                            this.odinContext = this.targetType.HasCustomAttribute<ShowOdinSerializedPropertiesInInspectorAttribute>(true);
        ...
        private void CreateMenuTree(bool force)
        {
            if (force || this.targetType != null && this.serializationInfoTree == null)
            {
                ...
                this.backendFlags = this.targetType.HasCustomAttribute<ShowOdinSerializedPropertiesInInspectorAttribute>(true) ? SerializationBackendFlags.UnityAndOdin : SerializationBackendFlags.Unity;
        ...
        private void DrawInfos()
        {
            ...
            {
                var info = this.serializationInfoTree.Selection[0].ObjectInstance as MemberSerializationInfo;
        ...
        [MenuItem("Tools/Odin Inspector/Serialization Debugger")]
