...
namespace Sirenix.OdinInspector.Editor
{
    ...
    {
        [HideInInspector, SerializeField] private bool showMonoScriptInEditor = true;
        [HideInInspector, SerializeField] private bool expandFoldoutByDefault = true;
        [HideInInspector, SerializeField] private bool hideFoldoutWhileEmpty = true;
        [HideInInspector, SerializeField] private bool openListsByDefault = true;
        [HideInInspector, SerializeField] private bool showItemCount = true;
        [HideInInspector, SerializeField] private int numberOfItemsPrPage = 15;
        [HideInInspector, SerializeField] private bool hidePagingWhileCollapsed = true;
        [HideInInspector, SerializeField] private bool hidePagingWhileOnlyOnePage = true;
        [HideInInspector, SerializeField] private bool showExpandButton = true;
        [HideInInspector, SerializeField] private QuaternionDrawMode quaternionDrawMode = QuaternionDrawMode.Eulers;
        ...
        private bool? markObjectsDirtyOnButtonClick;
        ...
        [ShowInInspector]
        [FoldoutGroup("General")]
        public bool MarkObjectsDirtyOnButtonClick
        {
            get
            {
                if (this.markObjectsDirtyOnButtonClick == null)
                {
                    this.markObjectsDirtyOnButtonClick = EditorPrefs.GetBool("GeneralDrawerConfig.MarkObjectsDirtyOnButtonClick", true);
                }

                return this.markObjectsDirtyOnButtonClick.Value;
            }
            set
            {
                this.markObjectsDirtyOnButtonClick = value;
                EditorPrefs.SetBool("GeneralDrawerConfig.MarkObjectsDirtyOnButtonClick", value);
            }
        }
