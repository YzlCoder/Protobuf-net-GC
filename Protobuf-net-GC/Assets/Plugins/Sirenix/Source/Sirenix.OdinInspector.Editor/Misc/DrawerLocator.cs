...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public static class DrawerLocator
    {
        ...
        public static OdinDrawer[] GetDrawersForProperty(InspectorProperty property)
        {
            ...
            {
                bool isListElement = property.ValueEntry != null && property.ValueEntry.ValueCategory != PropertyValueCategory.Member;

                // bool isListElementOld = property.ParentValueProperty != null && property.ParentValueProperty.Info == property.Info;
                // if (isListElement != isListElementOld)
                // {
